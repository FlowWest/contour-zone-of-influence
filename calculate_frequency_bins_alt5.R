...
write_csv(dsm2_samples_inflow_table, "data_export/tab2_samplesizes_inflowgroups_alts_dsm2_alt5.csv")
...
write_csv(dsm2_samples_inflow_omr_table, "data_export/tab4_samplesizes_inflowgroups_omr_alts_dsm2_alt5.csv")
...
bins_raw <- read_excel("data_raw/calsim/Reclamation_2021LTO_SacR_SJR_OMR_Binning_rev01_20230929_result.xlsx", skip = 5)
# rename column names
colnames(bins_raw) <- c("Date", "Flow_EXP1", "OMR_EXP1", "Flow_EXP3", "OMR_EXP3",
